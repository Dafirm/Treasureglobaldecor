...
export const metadata = {
  title:
    "Page Not Found || Treasure Global Decor — Event Styling & Elegant Spaces",
  description:
    "Treasure Global Decor specializes in transforming ordinary venues into extraordinary experiences with premium styling, floral designs, and bespoke decor solutions.",
};
                  ...
                  <ul className="clearlist scroll-nav local-scroll justify-content-end">
                    <li className="active">
                      <a href="mailto:ibthemes21@gmail.com">
                        ...
                        treasureglobaldeco@gmail.com
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i className="mi-call align-center" /> +358442388567
                      </a>
                    </li>
                  </ul>
                </div>
